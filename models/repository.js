        ...
        if (params) {
            ...
            for (let object of objectsList) {
                for (let searchKey of searchKeys) {
                    if (this.valueMatch(object[searchKey.key], searchKey.value) || object[searchKey.key] === searchKey.value)
            ...
            for (let sortKey of sortKeys) {
                if (sortKey.asc){
                    filteredAndSortedObjects.sort((a, b) => this.innerCompare(a[sortKey.key], b[sortKey.key]));
                }
                else{
                    filteredAndSortedObjects.sort((a, b) => this.innerCompare(b[sortKey.key], a[sortKey.key]));
                }
            }
